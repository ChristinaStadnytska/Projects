...
@IBDesignable class GraphView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let context = UIGraphicsGetCurrentContext()! //CG drawing functions need to know the context in which they will draw
